 ...
 * @author  __USER__
 */
public class mapFrame2 extends javax.swing.JFrame {
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
		change = 2;
		new gameFrame(2, 0).setVisible(true);
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
		change = 3;
		new gameFrame(3, 0).setVisible(true);
		//gameFrame.connection();
		startTime = System.currentTimeMillis();
		setVisible(false);
	}
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		new gameFrame(1, 0).setVisible(true);
	...
	private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
		change = 4;
		new gameFrame(4, 0).setVisible(true);
		startTime = System.currentTimeMillis();
		//gameFrame.connection();
		setVisible(false);
	}
